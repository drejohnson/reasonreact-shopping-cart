...
Css.(global("body", [color(hex("fff")), fontSize(rem(1.)), fontFamily("-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen',
      'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue',
      sans-serif")]))
Css.(global("h1,h2,h3,h4,h5,h6,", [fontFamily("'Montserrat', sans-serif;"), fontWeight(`num(500)), margin(zero)]))
